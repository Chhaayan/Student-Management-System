...
export default function School() {
    ...
    const navArr = [
        ...
        { link: "/school/class", component: "Class", icon:SchoolIcon  },
        { link: "/school/subject", component: "Subjects", icon: MenuBookIcon },
        { link: "/school/students", component: "Students", icon: GroupIcon },
        { link: "/school/teachers", component: "Teachers", icon: SupervisedUserCircleIcon },
        ...
        {link:"/school/payment", component:"Payment", icon:PaymentsIcon},
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            <CssBaseline />
            <AppBar sx={{ backgroundColor: "green", color: "white" }} position="fixed" open={open}>
                <Toolbar>
                    <IconButton
                        color="inherit"

...
export default function Login() {
    ...
    return (<Box component={'div'} sx={{width:"100%", height:"80vh", background:"url(https://www.kark.com/wp-content/uploads/sites/85/2021/02/classroom_1542034403442_61914801_ver1.0.jpg?w=1920&h=1080&crop=1)", backgroundSize:"cover"}}>

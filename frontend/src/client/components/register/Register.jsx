...
const resetMessage  =()=>{
    ...
    return (<Box component={'div'} sx={{width:"100%", minHeight:"80vh", background:"url(https://www.kark.com/wp-content/uploads/sites/85/2021/02/classroom_1542034403442_61914801_ver1.0.jpg?w=1920&h=1080&crop=1)", backgroundSize:"cover"}}>
...
<Box component={'div'} sx={{padding:'40px',maxWidth:"700px",margin:"auto"}} > 
    {message && <CustomizedSnackbars reset={resetMessage} type={type} message={message}/>}
        <Box sx={{ display: 'flex', justifyContent: "center", alignItems: "center", color: "white" }} component={'div'}>
